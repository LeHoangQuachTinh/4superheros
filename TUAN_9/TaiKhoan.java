...
public abstract class TaiKhoan {
    ...
    protected List<LichSuGiaoDich> lichSuGiaoDichThanhToan;
    ...
    public TaiKhoan() {
        this.lichSuGiaoDichThanhToan = new ArrayList<>();
    }
    ...
    public void guiTien(double tienGui){
        if(tienGui>0){
            ...
            themGiaoDichThanhToan("Gửi tiền", tienGui);
        }
        else
    ...
    public String generateMaGiaoDichThanhToan() {
        return "GD" + (lichSuGiaoDichThanhToan.size() + 1);
    }
    
    public void themGiaoDichThanhToan(String loaiGiaoDich, double soTien) {
        LichSuGiaoDich giaoDichThanhToan=new LichSuGiaoDich(generateMaGiaoDichThanhToan(), loaiGiaoDich, soTien, LocalDate.now());
        lichSuGiaoDichThanhToan.add(giaoDichThanhToan);
    }

    public List<LichSuGiaoDich> getLichSuGiaoDichThanhToan() {
        return lichSuGiaoDichThanhToan;
    }
    ...
    public void inLichSuGiaoDich(){
        ...
        for(LichSuGiaoDich gd: lichSuGiaoDichThanhToan){
