                ...
                case 1:
                    ...
                    if(AD.getMaQuanTri().equals(maQuanTri))
                    {
                        ...
                        do{
                            ...
                            System.out.println("4.Đổi mã quản trị viên");
                            System.out.println("0.Thoát");
                                   ...
                                   do{
                                        ...
                                        switch (choice) {
                                            ...
                                            case 3:
                                                ...
                                                AD.listRestaurant.editAccount(id);
                                            break;
                                            case 4:
                                        ...
                                        do{
                                            ...
                                            switch (choice) {
                                                ...
                                                case 3:
                                                    ...
                                                    String id=sc.nextLine();
                                                    AD.listCustomer.editAccount(id);
                                                break;
                                                case 4:
                                            ...
                                            do {
                                                ...
                                                switch (chon) {
                                                    case 1: // Thêm món
                                                        ...
                                                        System.out.println("Bạn có muốn thêm món này vào danh sách món ưu đãi không? (Y/N): ");
                                                        String them = sc.nextLine();
                                                        if(them.equalsIgnoreCase("Y")){
                                                            System.out.println("Nhập phần trăm giảm giá cho món ăn (ví dụ: 20 phần trăm thì nhập 20): ");
                                                            ...
                                                            System.out.println("""
                                                                    ...
                                                                    switch (luaChon) {
                                                                        ...
                                                                        case 3:
                                                                            ...
                                                                            break;
                                                                        default:
                                                                            System.out.println("Lựa chọn không hợp lệ. Thời gian ưu đãi mặc định là 3 ngày");
                                                                            thoiHan=10000;
                                                                    }
                                                            dish.setUuDai(true, phanTramGiam, thoiHan);
                                                            System.out.println("Món "+dish.getNameDish()+ " đã được thêm vào danh sách món ăn ưu đãi với "+phanTramGiam+" % giảm giá.");
                                                        }else{
                                                            System.out.println("Bạn đã không thêm món "+dish.getNameDish()+" không được thêm vào món ưu đãi.");
                                                        }
                                                    break;
                                                    ...
                                                    case 6: // Cập nhật thông tin nhà hàng
                                                        AD.listRestaurant.editAccount(nhaHangHienTai.idUser);
                                                        break;
                                                    case 7: // Thoát
                                    ...
                                    while (dem < 5) {
                                        ...
                                        if (tkCustomer.login(id, password)) {
                                            ...
                                            do {
                                                ...
                                                System.out.println("3.Xem trạng thái đơn hàng(bảo trì)");
