...
public class Dish {
    ...
    public String displayDish() {
        ...
        String discountPercentage = uuDai ? String.format("%.0f%%", giamGia) : "0%"; // Hiển thị phần trăm giảm giá nếu có
    
        // Hiển thị món ăn với các thông tin: mã món, tên món, giá, số lượng, phần trăm giảm giá và giá sau giảm
        return String.format("| %-10s | %-40s | %-15.0f | %-8d | %-8s | %-15.0f | %-10s |",
        idDish, nameDish + bestSellerFlag, price, quality, discountPercentage, discountedPrice, trangThaiGiamGia);
    }
