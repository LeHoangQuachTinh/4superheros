...
public class Shipper extends Account {
    ...
    // Constructor
    public Shipper(String idUser, String username, String password, String SDT, String diachi, String loaiXe,
            String STK) {
    ...
    public void lockAccount() {
        this.isLocked = true;
        System.out.println("Tài khoản của shipper " + getUsername() + " đã bị khóa.");
    }

    // Phương thức mở khóa tài khoản
    public void unlockAccount() {
        this.isLocked = false;
        System.out.println("Tài khoản của shipper " + getUsername() + " đã được mở khóa.");
    }

    // Phương thức lấy trạng thái khóa tài khoản
    ...
    public void setSDT(String newSDT) {
        this.SDT = newSDT;
        System.out.println("Số điện thoại của shipper " + getUsername() + " đã được thay đổi thành: " + newSDT);
    }

    // Phương thức thay đổi mật khẩu
    public void setPassword(String newPassword) {
        this.setPassword(newPassword);
        System.out.println("Mật khẩu của shipper " + getUsername() + " đã được thay đổi.");
    }
