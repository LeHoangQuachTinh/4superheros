...
//     if (menu.containsKey(maMon)) {
//         System.out.println("Mã món ăn đã tồn tại. Vui lòng nhập mã khác!");
//     } else {
//         // Nhập tên món
...
//                 } else {
//                     // Tạo món mới và thêm vào menu
//                     Dish newDish = new Dish(maMon, tenMon, price, soluong);
//                     menu.put(maMon, newDish); // Thêm món vào HashMap
//                     System.out.println("Đã thêm món: " + tenMon + " thành công!");
   
//                 }
//             } catch (InputMismatchException e) {
//                 System.out.println("Giá và số lượng phải là số hợp lệ. Vui lòng nhập lại!");
